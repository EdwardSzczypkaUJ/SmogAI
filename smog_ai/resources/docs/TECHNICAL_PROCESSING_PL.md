...
Langfuse oraz jawny proces publikacji DigitalOcean opisuje dokument
`HF20_TIME_CONTRACT_MLOPS_PL.md` i dodatek LaTeX
`DODATEK_TECHNICZNY_HF20_TIME_CONTRACT_MLOPS_PL.tex`.
