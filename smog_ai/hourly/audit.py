...
def audit_latest_hourly_serving_contract(
    ...
    *,
    ...
    for parameter in required:
        ...
        if model_target == "precipitation_mm":
    ...
    publication_ready = serving_contract_passed and not quality_failures
    partial_success = serving_contract_passed and bool(quality_failures)
