...
try {
    ...
    Write-Host 'SZYBKI RETRAINING — profil quick na niezmiennym snapshocie' -ForegroundColor Cyan
    Write-Host (
        'Importer może nadal działać. Monitor: scripts\Watch-TrainingProgress.ps1 -Mode quick'
